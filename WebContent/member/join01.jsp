	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<p style="text-align:center; margin-bottom:20px;"><input type="checkbox" id="agreement1" value="">이용약관과 개인정보취급방침에 동의합니다.</p>

				<p style="text-align:center; margin-bottom:20px">
					<img src="../images/btn01.gif" id = "join" style = "cursor: pointer;"/>&nbsp;&nbsp;
					<a href="#">
