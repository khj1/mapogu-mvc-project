...
<%@ include file="./common/edit_include.jsp" %>
<script> 
	$(function(){
...
<form enctype="multipart/form-data" method="post" action="./common/edit_process.jsp">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<div id="preview"><img src="../uploads/${bDto.sfile }" /></div>
			</td>
		</tr>
		<tr>
			<th class="text-center" 
