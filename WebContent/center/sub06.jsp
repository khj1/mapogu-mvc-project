		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<div class="con_box">
					...
					<!-- 맵 위치 -->
					<div id="map" style="width:500px;height:435px;"></div>
					<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b80cfc0a8d29752461757c82b6925503"></script>
					<script>
						var container = document.getElementById('map'); //지도를 담을 영역의 DOM 레퍼런스
						var options = { //지도를 생성할 때 필요한 기본 옵션
							center: new kakao.maps.LatLng(37.57429823896507, 126.89004703106735), //지도의 중심좌표.
						...
						// 마커가 표시될 위치입니다 
						var markerPosition  = new kakao.maps.LatLng(37.57429823896507, 126.89004703106735); 
